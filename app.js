...
const agentCopy = {
  ...
  brief: {
    title: "Проверяем основу проекта",
    copy: "Здесь можно поправить название, ссылку, аудиторию и главную задачу перед выбором дизайн-формулировок.",
  },
  task: {
    title: "Уточняем тип задачи",
    copy: "Выберите, что именно должен сделать сайт. Агент уже отметил варианты из вашего запроса.",
  },
  effect: {
    title: "Фиксируем нужный эффект",
    copy: "Здесь выбирается впечатление, которое сайт должен создать у аудитории.",
  },
  tone: {
    title: "Выбираем визуальный характер",
    copy: "Этот слой влияет на поиск референсов: типографику, сетку, фото и общий визуальный язык.",
  },
  avoid: {
    title: "Задаем ограничения",
    copy: "Анти-паттерны помогают агенту не увести moodboard в шаблоны, клише и неподходящий визуальный язык.",
  },
  directions: {
